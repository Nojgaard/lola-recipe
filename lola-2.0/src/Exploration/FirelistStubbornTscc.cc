...
/*!
  ...
  */
arrayindex_t FirelistStubbornTscc::getFirelist(NetState &ns, arrayindex_t **result)
{
    ...
    for (arrayindex_t firstunprocessed = 0; firstunprocessed < stackpointer; ++firstunprocessed)
    {
        ...
        {
            const arrayindex_t scapegoat = ns.Arc[TR][PRE][currenttransition][0];
...
Firelist *FirelistStubbornTscc::createNewFireList(SimpleProperty *property)
{
