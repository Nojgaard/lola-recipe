        ...
        AutomataTree *currentStateEntry)
{
    ...
    {
        get_next_transition(automata, ns, &currentStateListEntry, &currentFirelistEntry, currentFirelist,
                                   ...
                                   Store<AutomataTree *> &store, Firelist &firelist, NetState &ns)
{
    ...
    bool result = searchFair(automata, store, firelist, ns, currentAutomataState, *currentStateEntry,
