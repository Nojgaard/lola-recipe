...
\brief Definition of disjunctions for CTL.
*/
...
/*!
\brief disjunctions for CTL formulae
*/
class DisjunctionFormula : public CTLFormula
{
public:
    explicit DisjunctionFormula(std::vector<CTLFormula *>);
