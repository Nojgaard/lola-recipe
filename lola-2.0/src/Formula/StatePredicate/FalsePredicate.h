...
class FalsePredicate: public AtomicStatePredicate
{
public:
    FalsePredicate();
    ...
    virtual void evaluateOmega(NetState &) {}
...
private:
    ...
    virtual bool DEBUG__consistency(NetState &);
