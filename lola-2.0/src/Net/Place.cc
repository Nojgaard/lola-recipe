...
arrayindex_t *Place::CardDisabled = NULL;

/*!
The arrays Disabled[i] are allocated for the maximum number of such
transitions which is \f$card(p^\bullet)\f$
*/
arrayindex_t **Place::Disabled = NULL;

/*!
free memory for valgrind
\post Memory for Place::Hash Place::CardBits Place::CardDisabled
Place::Capacity and Place::Disabled is freed
*/
