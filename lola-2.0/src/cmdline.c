...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[16] = gengetopt_args_info_detailed_help[23];
  gengetopt_args_info_full_help[17] = gengetopt_args_info_detailed_help[24];
  gengetopt_args_info_full_help[18] = gengetopt_args_info_detailed_help[26];
  gengetopt_args_info_full_help[19] = gengetopt_args_info_detailed_help[27];
  gengetopt_args_info_full_help[20] = gengetopt_args_info_detailed_help[28];
  gengetopt_args_info_full_help[21] = gengetopt_args_info_detailed_help[30];
  gengetopt_args_info_full_help[22] = gengetopt_args_info_detailed_help[32];
  gengetopt_args_info_full_help[23] = gengetopt_args_info_detailed_help[34];
  gengetopt_args_info_full_help[24] = gengetopt_args_info_detailed_help[36];
  gengetopt_args_info_full_help[25] = gengetopt_args_info_detailed_help[37];
  gengetopt_args_info_full_help[26] = gengetopt_args_info_detailed_help[38];
  gengetopt_args_info_full_help[27] = gengetopt_args_info_detailed_help[40];
  ...
  gengetopt_args_info_full_help[30] = gengetopt_args_info_detailed_help[46];
  ...
  gengetopt_args_info_full_help[33] = gengetopt_args_info_detailed_help[52];
  gengetopt_args_info_full_help[34] = gengetopt_args_info_detailed_help[54];
  gengetopt_args_info_full_help[35] = gengetopt_args_info_detailed_help[56];
  gengetopt_args_info_full_help[36] = gengetopt_args_info_detailed_help[57];
  gengetopt_args_info_full_help[37] = gengetopt_args_info_detailed_help[58];
  gengetopt_args_info_full_help[38] = gengetopt_args_info_detailed_help[59];
  gengetopt_args_info_full_help[39] = gengetopt_args_info_detailed_help[60];
  gengetopt_args_info_full_help[40] = gengetopt_args_info_detailed_help[61];
  gengetopt_args_info_full_help[41] = gengetopt_args_info_detailed_help[62];
  gengetopt_args_info_full_help[42] = gengetopt_args_info_detailed_help[64];
  gengetopt_args_info_full_help[43] = gengetopt_args_info_detailed_help[66];
  gengetopt_args_info_full_help[44] = gengetopt_args_info_detailed_help[68];
  gengetopt_args_info_full_help[45] = gengetopt_args_info_detailed_help[69];
  gengetopt_args_info_full_help[46] = gengetopt_args_info_detailed_help[70];
  gengetopt_args_info_full_help[47] = gengetopt_args_info_detailed_help[72];
  gengetopt_args_info_full_help[48] = gengetopt_args_info_detailed_help[74];
  gengetopt_args_info_full_help[49] = gengetopt_args_info_detailed_help[76];
  gengetopt_args_info_full_help[50] = gengetopt_args_info_detailed_help[78];
  gengetopt_args_info_full_help[51] = gengetopt_args_info_detailed_help[79];
  gengetopt_args_info_full_help[52] = gengetopt_args_info_detailed_help[81];
  gengetopt_args_info_full_help[53] = gengetopt_args_info_detailed_help[83];
  gengetopt_args_info_full_help[54] = gengetopt_args_info_detailed_help[84];
  gengetopt_args_info_full_help[55] = gengetopt_args_info_detailed_help[85];
  gengetopt_args_info_full_help[56] = gengetopt_args_info_detailed_help[87];
  gengetopt_args_info_full_help[57] = gengetopt_args_info_detailed_help[89];
  gengetopt_args_info_full_help[58] = 0; 
  
}

const char *gengetopt_args_info_full_help[59];
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[15] = gengetopt_args_info_detailed_help[26];
  gengetopt_args_info_help[16] = gengetopt_args_info_detailed_help[27];
  gengetopt_args_info_help[17] = gengetopt_args_info_detailed_help[28];
  gengetopt_args_info_help[18] = gengetopt_args_info_detailed_help[30];
  gengetopt_args_info_help[19] = gengetopt_args_info_detailed_help[36];
  gengetopt_args_info_help[20] = gengetopt_args_info_detailed_help[37];
  gengetopt_args_info_help[21] = gengetopt_args_info_detailed_help[38];
  gengetopt_args_info_help[22] = gengetopt_args_info_detailed_help[60];
  gengetopt_args_info_help[23] = gengetopt_args_info_detailed_help[61];
  gengetopt_args_info_help[24] = gengetopt_args_info_detailed_help[62];
  gengetopt_args_info_help[25] = gengetopt_args_info_detailed_help[64];
  gengetopt_args_info_help[26] = gengetopt_args_info_detailed_help[66];
  gengetopt_args_info_help[27] = gengetopt_args_info_detailed_help[68];
  gengetopt_args_info_help[28] = gengetopt_args_info_detailed_help[69];
  gengetopt_args_info_help[29] = gengetopt_args_info_detailed_help[70];
  gengetopt_args_info_help[30] = gengetopt_args_info_detailed_help[85];
  gengetopt_args_info_help[31] = gengetopt_args_info_detailed_help[87];
  gengetopt_args_info_help[32] = gengetopt_args_info_detailed_help[89];
...
const char *cmdline_parser_search_values[] = {"depth", "findpath", "sweepline", "covergraph", 0}; /*< Possible values for search. */
const char *cmdline_parser_stubborn_values[] = {"tarjan", "deletion", 0}; /*< Possible values for stubborn. */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->stubborn_help = gengetopt_args_info_detailed_help[16] ;
  args_info->cycle_help = gengetopt_args_info_detailed_help[18] ;
  args_info->symmetry_help = gengetopt_args_info_detailed_help[20] ;
  args_info->compressed_help = gengetopt_args_info_detailed_help[24] ;
  args_info->state_help = gengetopt_args_info_detailed_help[28] ;
  args_info->path_help = gengetopt_args_info_detailed_help[30] ;
  args_info->pathshape_help = gengetopt_args_info_detailed_help[32] ;
  args_info->writeCompressed_help = gengetopt_args_info_detailed_help[34] ;
  args_info->quiet_help = gengetopt_args_info_detailed_help[38] ;
  args_info->reporter_help = gengetopt_args_info_detailed_help[40] ;
  args_info->json_help = gengetopt_args_info_detailed_help[42] ;
  args_info->jsoninclude_help = gengetopt_args_info_detailed_help[44] ;
  args_info->jsoninclude_min = 0;
  args_info->jsoninclude_max = 0;
  args_info->nolog_help = gengetopt_args_info_detailed_help[46] ;
  args_info->outputport_help = gengetopt_args_info_detailed_help[48] ;
  args_info->inputport_help = gengetopt_args_info_detailed_help[50] ;
  args_info->address_help = gengetopt_args_info_detailed_help[52] ;
  args_info->remoteTermination_help = gengetopt_args_info_detailed_help[54] ;
  args_info->printNet_help = gengetopt_args_info_detailed_help[57] ;
  args_info->stats_help = gengetopt_args_info_detailed_help[58] ;
  args_info->tscc_help = gengetopt_args_info_detailed_help[59] ;
  args_info->timelimit_help = gengetopt_args_info_detailed_help[62] ;
  args_info->symmtimelimit_help = gengetopt_args_info_detailed_help[64] ;
  args_info->markinglimit_help = gengetopt_args_info_detailed_help[66] ;
  args_info->store_help = gengetopt_args_info_detailed_help[70] ;
  args_info->encoder_help = gengetopt_args_info_detailed_help[72] ;
  args_info->bucketing_help = gengetopt_args_info_detailed_help[74] ;
  args_info->hashfunctions_help = gengetopt_args_info_detailed_help[76] ;
  args_info->ltlmode_help = gengetopt_args_info_detailed_help[78] ;
  args_info->sweepfronts_help = gengetopt_args_info_detailed_help[79] ;
  args_info->sweeplinedelay_help = gengetopt_args_info_detailed_help[81] ;
  args_info->sweeplinespread_help = gengetopt_args_info_detailed_help[83] ;
  args_info->cycleheuristic_help = gengetopt_args_info_detailed_help[84] ;
  args_info->retrylimit_help = gengetopt_args_info_detailed_help[85] ;
  args_info->depthlimit_help = gengetopt_args_info_detailed_help[87] ;
  args_info->threads_help = gengetopt_args_info_detailed_help[89] ;
