...
m4_define([AT_PACKAGE_VERSION],   [2.0])
m4_define([AT_PACKAGE_STRING],    [LoLA 2.0])
m4_define([AT_PACKAGE_BUGREPORT], [lola@service-technology.org])

# SVN Revision-URL
m4_define([SVNURL],               [http://svn.gna.org/viewcvs/service-tech?rev=Unversioned directory&view=rev])

# directories
m4_define([TESTFILES],            [/home/nikolai/share/lola-2.0/tests/testfiles])
m4_define([BENCHRESULTS],         [/home/nikolai/share/lola-2.0/tests/benchmarks-results])
...
m4_define([LOLA],       [cover.sh /home/nikolai/share/lola-2.0/src/lola --nolog])
m4_define([LISTENER],   [cover.sh /home/nikolai/share/lola-2.0/utils/listener])
m4_define([KILLER],     [cover.sh /home/nikolai/share/lola-2.0/utils/killer])

# the main executable, directly called to allow for analysis
m4_define([LOLA_RAW],  [/home/nikolai/share/lola-2.0/src/lola --nolog])

# a LoLA call to check the logging functionality
m4_define([LOLA_LOG],  [cover.sh /home/nikolai/share/lola-2.0/src/lola])
...
# AT_CHECK_RUNLOLA(label, file, check, store, threads, hashfunctions, result, markings, edges)
